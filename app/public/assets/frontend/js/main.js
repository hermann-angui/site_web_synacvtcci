(function ($) {
    ...
    $(document).ready(function () {
        ...
        function stickyHeader() {
            var primaryHeader = $(".nav-menu-wrapper"), headerClone = primaryHeader.clone();
            $(".main-header").after('<div class="sticky-header"></div>');
            $(".sticky-header").html(headerClone);
            var headerSelector = document.querySelector(".sticky-header"), triggerPoint = $(".main-header").height(),
                yOffset = 0;
        ...
        var sliderOptions = {
            ...
            effect: 'fade',
            a11y: false,
            pagination: {el: '.main-slider .slider-pagination', clickable: true, type: 'fraction',},
            navigation: {nextEl: '.main-slider .slider-button-next', prevEl: '.main-slider .slider-button-prev'}
        };
        sliderOptions.on = {
        ...
        var sliderOptions2 = {
            ...
            a11y: false,
            pagination: false,
            navigation: {nextEl: '.main-slider-2 .swiper-next', prevEl: '.main-slider-2 .swiper-prev'}
        };
        sliderOptions2.on = {
            slideChangeTransitionStart: function () {
                var swiper = this;
        ...
        var swiperService = new Swiper(".service-carousel", {
            ...
            navigation: {nextEl: ".swiper-outside .swiper-next", prevEl: ".swiper-outside .swiper-prev",},
            breakpoints: {
        ...
        var swiperTestimonial = new Swiper(".testimonial-carousel", {
            ...
            autoplay: false,
            speed: 400,
            pagination: {el: ".testi-pagination .swiper-pagination", clickable: true,},
            navigation: false,
        });
        ...
        });/*var cursor=$(".dl-cursor"),linksCursor=$("a, .swiper-nav, .cursor-effect, .swiper-pagination > span, button, .menu-right-item > div"),crossCursor=$("#sidebox-overlay, #searchbox-overlay");$(window).on("mousemove",function(e){cursor.css({transform:"translate("+(e.clientX-15)+"px,"+(e.clientY-15)+"px)",visibility:"inherit",});});$(window).on("mouseout",function(){cursor.css("visibility","hidden");});linksCursor.each(function(){$(this).on("mouseleave",function(){cursor.removeClass("cursor-grow");});$(this).on("mouseover",function(){cursor.addClass("cursor-grow");});});crossCursor.each(function(){$(this).on("mouseleave",function(){cursor.removeClass("cross");});$(this).on("mouseover",function(){cursor.addClass("cross");});});*/
        ...
        $('.time-picker').datetimepicker({datepicker: false, format: 'H:i', step: 5});
