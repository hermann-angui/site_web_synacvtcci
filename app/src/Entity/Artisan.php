...
#[UniqueEntity(fields: ['phone','mobile','IdNumber','drivingLicenseNumber', 'email', 'tracking_code'])]
class Artisan implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(type: 'string', length: 255, nullable: true)]
    private ?string $payment_receipt_service_technique_pdf = null;
    ...
    #[ORM\Column(type: 'string', length: 1204, nullable: true)]
    private ?string $enrolement_rejected_reason = null;

    #[ORM\Column(type: 'string', length: 1204, nullable: true)]
    private ?string $enrolement_payment_rejected_reason = null;
    ...
    public function removeChild(Child $child): self
    {
        if ($this->children->removeElement($child)) {
            ...
            if ($child->getArtisan() === $this) {
                $child->setArtisan(null);
            }
        }
     ...
     * @return Artisan
     */
    public function setBirthLocality(?string $birth_locality): Artisan
    {
     ...
     * @return Artisan
     */
    public function setIdDeliveryAuthority(?string $IdDeliveryAuthority): Artisan
    {
     ...
     * @return Artisan
     */
    public function setPostalCode(?string $postal_code): Artisan
    {
     ...
     * @return Artisan
     */
    public function setCompany(?array $company): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivityGeoLocation(?string $activity_geo_location): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivityCountryLocation(?string $activity_country_location): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivityCityLocation(?string $activity_city_location): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivityQuartierLocation(?string $activity_quartier_location): Artisan
    {
     ...
     * @return Artisan
     */
    public function setSocioprofessionnelleCategory(?string $socioprofessionnelle_category): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivity(?string $activity): Artisan
    {
     ...
     * @return Artisan
     */
    public function setActivityDateDebut(?\DateTimeInterface $activity_date_debut): Artisan
    {
     ...
     * @return Artisan
     */
    public function setBirthCountry(?string $birth_country): Artisan
    {
     ...
     * @return Artisan
     */
    public function setPaymentReceiptCnmciPdf(?string $payment_receipt_cnmci_pdf): Artisan
    {
     ...
     * @return Artisan
     */
    public function setPaymentReceiptCnmciCode(?string $payment_receipt_cnmci_code): Artisan
    {
     ...
     * @return Artisan
     */
    public function setTrackingCode(?string $tracking_code): Artisan
    {
     ...
     * @return Artisan
     */
    public function setReferantFirstName(?string $referant_firstName): Artisan
    {
     ...
     * @return Artisan
     */
    public function setReferantLastName(?string $referant_lastName): Artisan
    {
     ...
     * @return Artisan
     */
    public function setReferantMobile(?string $referant_mobile): Artisan
    {
     ...
     * @return string|null
     */
    public function getPaymentReceiptServiceTechniquePdf(): ?string
    {
        return $this->payment_receipt_service_technique_pdf;
    }

    /**
     * @param string|null $payment_receipt_service_technique_pdf
     * @return Artisan
     */
    public function setPaymentReceiptServiceTechniquePdf(?string $payment_receipt_service_technique_pdf): Artisan
    {
        if($payment_receipt_service_technique_pdf) $this->payment_receipt_service_technique_pdf = $payment_receipt_service_technique_pdf;
        return $this;
    }
     ...
     * @return Artisan
     */
    public function setFormulaireCnmciPdf(?string $formulaire_cnmci_pdf): Artisan
    {
     ...
     * @return Artisan
     */
    public function setEtape(?int $etape): Artisan
    {
        $this->etape = $etape;
        return $this;
    }
     ...
     * @return Artisan
     */
    public function setHasPaidFraisEnrollement(?bool $has_paid_frais_enrollement): Artisan
    {
     ...
     * @return Artisan
     */
    public function setCnmciNumeroRm(?string $cnmci_numero_rm): Artisan
    {
     ...
     * @return Artisan
     */
    public function setCnmciNumeroCarteProfessionelle(?string $cnmci_numero_carte_professionelle): Artisan
    {
    ...
    public function setActivitySecondary(?string $activity_secondary): Artisan
    {
    ...
    public function setIsInscriptionValidated(?bool $is_inscription_validated): Artisan
    {
    ...
    public function setIsPaymentValidated(?bool $is_payment_validated): Artisan
    {
    ...
    public function setCnmciCardFrontImage(?string $cnmci_card_front_image): Artisan
    {
    ...
    public function setCnmciCardBackImage(?string $cnmci_card_back_image): Artisan
    {
    ...
    public function setContravention(?Contravention $contravention): self
    {
        ...
        if ($contravention === null && $this->contravention !== null) {
            $this->contravention->setTarget(null);
        }

        // set the owning side of the relation if necessary
        if ($contravention !== null && $contravention->getTarget() !== $this) {
            $contravention->setTarget($this);
        }
    ...
    public function getEnrolementRejectedReason(): ?string
    {
        return $this->enrolement_rejected_reason;
    }

    public function setEnrolementRejectedReason(?string $enrolement_rejected_reason): Artisan
    {
        $this->enrolement_rejected_reason = $enrolement_rejected_reason;
        return $this;
    }

    public function getEnrolementPaymentRejectedReason(): ?string
    {
        return $this->enrolement_payment_rejected_reason;
    }

    public function setEnrolementPaymentRejectedReason(?string $enrolement_payment_rejected_reason): Artisan
    {
        $this->enrolement_payment_rejected_reason = $enrolement_payment_rejected_reason;
        return $this;
    }
