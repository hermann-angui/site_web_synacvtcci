...
class MemberController extends AbstractController
{
    ...
    public function generateCard(Request $request, MemberRequestDto $memberRequestDto, MemberService $memberService): Response
    {
        $memberRequestDto = $memberService->generateMemberCard($memberRequestDto);
    ...
    public function showCard(Request $request,MemberRequestDto $member): Response
    {
    ...
    public function downloadCard(Request $request,MemberRequestDto $memberRequestDto, MemberService $memberService): Response
    {
        date_default_timezone_set("Africa/Abidjan");
        set_time_limit(3600);
        $memberService->generateMemberCard($memberRequestDto);
        $cardPhotoRealPath = $this->getParameter('kernel.project_dir') . "/public/members/" . $memberRequestDto->getMatricule() . "/" . $memberRequestDto->getCardPhoto();
    ...
    public function show(MemberRequestDto $memberRequestDto): Response
    {
